...
(function () {
	...
	angular.module('oblique.core')
		.controller('AppController', ["CONFIG", "SessionService", "AuthService", "$scope", "$rootScope", "$state", "$log", "$translate", "LoadingService", function (CONFIG, SessionService, AuthService, $scope, $rootScope, $state, $log, $translate, LoadingService) {
			var $this = this;
